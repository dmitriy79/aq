...
static const uint256 hashGenesisBlock("0x00000a095c1e859a071d92505484931b0db2d0685574d7496b55121df07afa89");
static const uint256 hashGenesisBlockTestNet("0x00000a095c1e859a071d92505484931b0db2d0685574d7496b55121df07afa89");
...
public:
    ...
    {
        // RolleyCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // RolleyCoin: get transaction coin age
...
public:
    ...
    // RolleyCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // RolleyCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // RolleyCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // RolleyCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // RolleyCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // RolleyCoin: block index flags
    enum  
    {
